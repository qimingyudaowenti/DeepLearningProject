...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            #print("hidden_inputs.shape:" + str(hidden_inputs.shape))#hidden_inputs.shape:(3,)
            
            hidden_outputs = self.activation_function(np.dot(X, self.weights_input_to_hidden)) # signals from hidden layer
            #print("hidden_outputs.shape:" + str(hidden_outputs.shape))#hidden_outputs.shape:(2,)
            
            # TODO: Output layer - Replace these values with your calculations.
            final_inputs = np.dot(hidden_outputs, self.weights_hidden_to_output) # signals into final output layer
            #print("final_inputs.shape:" + str(final_inputs.shape))#final_inputs.shape:(1,)
            ...
            #print("hidden_error.shape:" + str(hidden_error.shape))#hidden_error.shape:(2,)
            ...
            #print("(output_error_term * hidden_outputs).shape:" + str((output_error_term * hidden_outputs).shape))
